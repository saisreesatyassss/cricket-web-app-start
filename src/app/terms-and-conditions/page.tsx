    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow p-6">
        ...
        <div className="text-sm text-gray-600 mb-8">
          <em>Disclaimer: In case of any discrepancy or difference, the English version will take precedence over the translation</em>
        </div>
        ...
        <div className="space-y-6">
          <section>
            <div className="space-y-4">
              <p className="text-gray-700">
                We value the trust you place in us and recognize the importance of secure transactions and information privacy. This Privacy Policy describes how PinTude Solutions LLP and its affiliates (collectively “PinTude Solutions LLP, we, our, us”) collect, use, share or otherwise process your personal data through PinTude Solutions LLP website www.pintude.com, its mobile application, and m-site (hereinafter referred to as the “Platform”).                </p>
              <p className="text-gray-700">
          ...
          <section>
            ...
            <p className="text-gray-700">
                If you enroll into our loyalty and membership program, offered by PinTude Solutions LLP, we will collect and store your personal data such as name, contact number, email address, communication address, date of birth, gender, zip code, lifestyle information, demographic and work details which is provided by you to PinTude Solutions LLP or a third-party business partner that operates online/offline establishments or platforms where you can earn loyalty points for purchase of goods and services, and redeem loyalty points. We will also collect your information related to your transactions on PinTude Solutions LLP platform and such third-party business partner platforms. When such a third-party business partner collects your personal data directly from you, you will be governed by their privacy policies. Additionally, we collect your UPI ID if you choose to pay via our PinTude Solutions LLP UPI platform. PinTude Solutions LLP shall not be responsible for the third-party business partner’s privacy practices or the content of their privacy policies, and we request you to read their privacy policies prior to disclosing any information.            </p>
            <p className="text-gray-700">
                PinTude Solutions LLP has onboarded certain third-party business partners on the Platform who specialize in the categories like travel ticket reservations, booking online movie tickets, paying online bills and more. If you use the services of Partners, you will be redirected to Partners websites/applications and your entry to Partners websites/applications will be based on your PinTude Solutions LLP login credentials after seeking your permissions to share the data further. PinTude Solutions LLP shall not be responsible for the Ultra-Partner’s privacy practices or the content of their privacy policies, and we request you to read their privacy policies prior to disclosing any information.            </p>
            
            </div>
          </section>

          <section>
            <h2 className="text-xl font-semibold mb-3">Use of Demographic / Profile Data / Your Information</h2>
            <div className="space-y-4">
              <p className="text-gray-700">
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3">Sharing of personal data</h2>
            <div className="space-y-4">
              <p className="text-gray-700">
                We may share personal data internally within PinTude Solutions LLP group companies including PinTude Solutions and other PinTude Solutions LLP affiliates, related companies and third parties, including Credit Bureaus and business partners (such as UPI platform), for purposes of providing products and services offered by them, such as, personal loans offered by PinTude Solutions LLP through its lending partners, insurance, the deferred payment options, offered by PinTude Solutions LLP through its lending partners. These entities and affiliates may share such information with their affiliates, business partners and other third parties for the purpose of conducting the required checks, namely for the purpose of credit underwriting, providing you their products and services and may market to you as a result of such sharing unless you explicitly opt-out.              </p>
              <p className="text-gray-700">
          ...
          <section>
            ...
            <div className="space-y-4">
              <p className="text-gray-700">
                Our Platform may provide links to other websites or applications that may collect personal data about you and you will be governed by their privacy policies. PinTude Solutions LLP shall not be responsible for the privacy practices or the content of their privacy policies, and we request you to read their privacy policies prior to disclosing any information.              </p>
            </div>
          </section>
          <section>
            <h2 className="text-xl font-semibold mb-3">Security Precautions</h2>
            <div className="space-y-4">
              <p className="text-gray-700">
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3">Choice/Opt-Out</h2>
            <div className="space-y-4">
              <p className="text-gray-700">
                We provide all users with the opportunity to opt-out of receiving non-essential (promotional, marketing-related) communications after setting up an account with us. If you do not wish to receive promotional communications from us, then please login into the Notification Preference page of Platform [https://www.pintude.com] to unsubscribe/opt-out.             </p>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-semibold mb-3">Advertisements on Platform</h2>
            <div className="space-y-4">
              <p className="text-gray-700">
                We use third-party advertising companies to serve ads when you visit our Platform. These companies may use information (not including your name, address, email address, or telephone number) about your visits to this and other websites in order to provide personalized advertisements about goods and services of interest to you. You have an option to opt out from tracking of personalized advertising using the “Opt out of Ads Personalization” settings using your device’s settings application. PinTude Solutions LLP will have no access to your GAID once you select this feature.              </p>
                </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                {/* <p className="font-medium">Mr. Priyanshu Singh</p> */}
                <p>Designation: Senior Manager</p>
                <p>PinTude Solutions LLP</p>
                <p>Email: grievance.officer@pintude.biz</p>
                {/* <p>Phone: +91 82996 14046</p> */}
                <p>Time: Mon - Sat (9:00 - 17:30)</p>
              </div>
            </div>
          </section>
